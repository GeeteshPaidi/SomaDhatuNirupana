...
\begin{figure}[!t]
  ...
  \caption{Dayside footprint coverage of the 1{,}056{,}619 preprocessed
    spectra on a $1^{\circ}\times1^{\circ}$ grid, underlying the 99.0\%
    global coverage figure reported in Section~VII-B of the main paper.
    Coloured cells are sampled; the near-uniform fill across all
    longitudes and latitudes is what makes the reliable-band correlation
    and validation analyses in the main paper statistically meaningful.}
